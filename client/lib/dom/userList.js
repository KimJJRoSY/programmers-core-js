...
//만드는 순서 - loadingSpinner 생성 -> 렌더링
function creatLoadingSpinner(
  size = 100,
...
export function createEmptyUserCard() {
  return `
...
export function renderSpinner(target) {
  insertLast(target, creatLoadingSpinner());
}

export function renderEmptyUserCard(target) {
  insertLast(target, createEmptyUserCard());
}
